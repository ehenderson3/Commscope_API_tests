...
public class AntennaTest extends RestAssuredConfig {
    ...
    /**COM-542
     * Acceptance Criteria
     full revisions only IF ( search by /antenna-specs/antenna-code/DC1234?includeRevisions=true)
     only search revisions if 6 characters (full code) is searched
     only search revisions if include revisions is TRUE
     one step revisions (for all the existing 2D array search)
     include revisions is TRUE
     /antenna-specs?search=[[\{"value": "02306AY", "field": "antennaCode", "operator": "LIKE"}]]&includeRevisions=true
     Swagger UI
     https://comsearch.dev.surgeforward.com:8443/swagger-ui.html#!/antenna-spec-resource/getAllAntennaSpecsUsingGET
     * @throws UnsupportedEncodingException
     */

    @Test
        public void getAntennaSpecsSearch_revisionFalseEQ_ResultsetContainsRevisions() throws UnsupportedEncodingException {
            ...
            given()
                    ...
                    .body("entities.antennaSpecId[2]", equalTo(2))
                    .body("entities.antennaSpecId[3]", equalTo(2))
                    .body("entities.antennaSpecId[4]", equalTo(2))
                    ...
                    .body("entities.antennaCode[3]", equalTo("02306AY"))
                    .body("entities.antennaCode[4]", equalTo("02306AY"))
    ...
    @Test
    public void getAntennaSpecsSearch_revisionFalseLIKE_ResultsetContainsRevisions() throws UnsupportedEncodingException {
        String valueVal = "02306AZ";
        String fieldVal = "antennaCode";
    ...
    @Test
    public void getAntennaSpecsSearch_revisionTrue_ResultError() throws UnsupportedEncodingException {
        ...
        given()
                ...
                .prettyPeek()
                .then()
                .body("message", equalTo("Successfully retrieved 16 antennaSpecs"))
    ...
    public void getAntennaSpecsSsearch_value02306AYantennaCodeOpNOT_ResultsetContains02306AZantennaCode() throws UnsupportedEncodingException {
        ...
        given()
                ...
                .body("entities.antennaCode[3]", equalTo("02306AY"))
                .body("entities.antennaCode[4]", equalTo("02306AY"))
                .body("entities.antennaCode[5]", equalTo("02306AX"))
                .body("entities.antennaCode[6]", equalTo("02306A"))
                .body("entities.antennaCode[7]", equalTo("02306A"))
                .body("entities.antennaCode[8]", equalTo("02306A"))
                .body("entities.antennaCode[9]", equalTo("02306A"))
                .body("entities.antennaCode[11]", equalTo("77100A"))
                .body("entities.antennaCode[12]", equalTo("XXXXXX"))
                .body("entities.antennaCode[13]", equalTo("YYYYYY"))
                .body("entities.antennaCode[14]", equalTo("3032RF"))
                .body("entities.antennaCode[15]", equalTo("S01000"));
    ...
    public void getAntennaSpecsSsearch_value02306antennaCodeOpLIKE_ResultsetContains02306antennaCode() throws UnsupportedEncodingException {
        ...
        given()
                ...
                .body("entities.antennaCode[3]", equalTo("02306AY"))
                .body("entities.antennaCode[4]", equalTo("02306AY"))
                .body("entities.antennaCode[5]", equalTo("02306AY"))
                .body("entities.antennaCode[6]", equalTo("02306AX"))
                .body("entities.antennaCode[7]", equalTo("02306AX"))
                .body("entities.antennaCode[8]", equalTo("02306AX"))
                .body("entities.antennaCode[9]", equalTo("02306AX"))
                .body("entities.antennaCode[10]", equalTo("02306AX"))
                .body("entities.antennaCode[11]", equalTo("02306A"))
                .body("entities.antennaCode[12]", equalTo("02306A"))
                .body("entities.antennaCode[13]", equalTo("02306A"))
                .body("entities.antennaCode[14]", equalTo("02306A"))
                .body("entities.antennaCode[15]", equalTo("02306A"));
    ...
    public void getAntennaSpecsSearch_value02306antennaCodeOpEQ_ResultsetContainsCommscopemanufacturerName() throws UnsupportedEncodingException{
        ...
        given()
                ...
                .prettyPeek()
                .then()
                .body("message", equalTo("Successfully retrieved 19 antennaSpecs"))
                .body("count", equalTo(19))
